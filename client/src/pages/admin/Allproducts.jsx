...
import { DeleteProduct, addOffers, removeOffers,  GetCategoryByid, listProducts } from "../../services/UserService";
...
function AllProducts() {
  ...
  const handleRemoveOffer = (id) => {
    removeOffers(id)
      ...
      .catch((error) => {const errorMsg = error.response?.data?.error || "Something went wrong";
      toast.error(errorMsg);
      console.error(errorMsg);});
  };
