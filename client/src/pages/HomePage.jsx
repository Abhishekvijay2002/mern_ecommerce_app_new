  ...
  useEffect(() => {
    const fetchHomepageData = async () => {
      try {
        ...
        console.log("Categories Response:", categoriesRes); // Debugging
  ...
  return (
    <div>
      ...
      <section className="py-16 px-8 bg-[var(--secondary-bg-color)] relative">
        ...
        <div className="flex gap-6 overflow-hidden mx-auto justify-center" ref={categoryRef}>
          {categories.length > 0 ? (
            ...
            <p className="text-center text-red-500">Categories could not be loaded.</p>
          )}
        </div>
        <button
